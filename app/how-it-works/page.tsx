...
const specs = [
  { label: "Standard Turnaround", value: "3–4 Weeks", sub: "Design approval to your door" },
  { label: "Rush Orders", value: "15 Days", sub: "Subject to capacity & quantity" },
  { label: "Minimum Order", value: "10 Pieces", sub: "Per design, colour & style" },
];
...
export default function HowItWorksPage() {
  return (
    <>
      <PageHero
        title="How It Works"
        subtitle="From concept to delivery in 3–4 weeks. Here's our simple, transparent process."
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`flex-1 ${isEven ? "lg:text-right" : ""}`}>
                      <div className={`bg-gray-50 rounded-2xl p-8 border border-gray-100 hover:shadow-lg transition-shadow duration-300 max-w-lg ${isEven ? "lg:ml-auto" : ""}`}>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {specs.map((spec, idx) => (
              ...
              >
                <div className={`text-4xl font-[family-name:var(--font-oswald)] font-bold mb-2 ${idx === 0 ? "text-orange-400" : "text-orange-500"}`}>
                  {spec.value}
                </div>
                <div className={`font-bold text-lg mb-1 ${idx === 0 ? "text-white" : "text-gray-900"}`}>
                  {spec.label}
                </div>
                <div className={`text-sm ${idx === 0 ? "text-gray-300" : "text-gray-500"}`}>
                  {spec.sub}
                </div>
              </div>
            ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                Before bulk production, you can request physical samples to verify quality, fit,
                and colour accuracy. We also send photos and videos of every sample for remote
                approval — no matter where you are in the world.
              </p>
              <p className="text-gray-600 leading-relaxed">
                A test print is conducted on every order before full production begins, ensuring
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                { label: "Unlimited Revisions", desc: "Until you're satisfied" },
              ].map((item) => (
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-xl mx-auto">
              50% advance required to begin production. Balance due before shipment.
            </p>
          </div>
          <div className="mb-8">
            <PaymentLogoCards />
