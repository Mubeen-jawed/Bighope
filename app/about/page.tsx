...
const partners = [
  { name: "USA", flagCode: "us", role: "US Shop" },
  { name: "Australia", flagCode: "au", role: "Partner Support" },
  { name: "Spain", flagCode: "es", role: "Partner Support" },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                Big Hope is an international manufacturer of custom sports
                uniforms, serving clubs, schools, and B2B partners worldwide.
                With production in Pakistan and partners across the USA,
                Australia, Spain, and the UK, we deliver quality teamwear with
                trusted local support.
              </p>
              <p className="text-gray-600 leading-relaxed">
                Professional-grade uniforms shouldn&apos;t come with premium
                price tags. Every order, from grassroots clubs to global
                distributors, is backed by the same reliability, honest
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-[#1e3056] text-white rounded-2xl p-6 sm:p-8 md:p-10">
              ...
              <p className="text-gray-300 leading-relaxed text-sm sm:text-base">
                Helping athletes and teams dream bigger with quality custom
                teamwear, without premium brand pricing. From grassroots clubs
                to semi-pro academies, we deliver reliable, professional-grade
                apparel.
              </p>
            </div>
            <div className="bg-orange-500 text-white rounded-2xl p-6 sm:p-8 md:p-10">
              ...
              <p className="text-white/90 leading-relaxed text-sm sm:text-base">
                Building a community driven by big ambitions, where Big Hope
                helps people achieve their goals, through custom teamwear or by
                supporting them in growing their own sports business.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center">
            <div>
              ...
              <div className="w-16 h-1 bg-orange-500 rounded mb-5" />
              <p className="text-gray-600 leading-relaxed">
                Big Hope was founded to give every team access to
                professional-quality uniforms, without the high price tag. From
                small local clubs to international distributors, our growth has
                been built on reliability, honest communication, and long-term
                partnerships.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600 max-w-xl mx-auto text-sm sm:text-base">
              Production in Sialkot with partner support across three
              continents, consistent quality delivered worldwide.
            </p>
          </div>
