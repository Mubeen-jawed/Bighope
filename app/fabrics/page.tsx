...
const fabrics = [
  ...
  {
    name: "Micro Interlock / Smooth Interlock",
    category: "Interlock",
  ...
  {
    name: "Needle-Drop Micro Fiber",
    category: "Micro Fiber",
  ...
  },
  {
    ...
    properties: [
      ...
      "Elasticity",
      "Semi-Soft",
      "Sweat-Drying / Breathable",
      "From 100g to 200+g",
    ],
  },
  {
    name: "Micro Mesh 4-Tuk",
    category: "Mesh",
    image: "/fabrics/mesh.png",
    properties: [
      "100% Polyester",
      "Knitted Elasticity",
      "Breathable / Semi-Soft",
      "From 100g to 200+g",
      "Shrink Resistant",
    ],
  },
  {
    name: "Micro Mesh 3-Tuk",
    category: "Mesh",
    image: "/fabrics/mesh.png",
    properties: [
      "100% Polyester",
  ...
  {
    name: "4-Way Stretch Fabric / Lycra",
    category: "Stretch",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                Fabric selection is one of the most important steps in the
                custom ordering process. Key factors to consider include fabric
                type, GSM, colour shade, performance features, and overall feel.
              </p>
              <p className="text-gray-600 leading-relaxed mb-4">
                At Big Hope Sports, we typically recommend exchanging fabric
                samples before moving into production. While this can involve
                additional costs due to offshore shipping, many of our
                professional clients prefer this step, especially for large
                orders, to ensure consistent quality and, when needed, support
                with laboratory test reports.
              </p>
              <p className="text-gray-600 leading-relaxed mb-6">
                In some cases, clients request unique fabrics that are not
                readily available in stock. These may require custom knitting,
                which is only feasible for larger orders of around 400 pieces or
                more of the same fabric. However, for regular fabrics, there is
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div>
              ...
              <p className="text-gray-300 max-w-xl">
                For large orders, we offer fully customised fabric with specific
                GSM, colour shade, performance specs, and construction, knitted
      ...
      <section className="py-16 bg-white">
        <div className="max-w-xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-500 mb-6">
            Tell us your sport and we&apos;ll recommend the perfect fabric for
            your order.
          </p>
          <Link
            href="/contact"
