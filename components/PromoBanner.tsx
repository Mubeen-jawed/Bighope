    ...
    <section className="bg-[#1e3056] text-white py-20 px-4 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
          <a
            href="/contact"
            className="inline-block bg-blue-600 hover:bg-blue-700 text-white font-bold px-7 sm:px-10 py-3 sm:py-4 rounded-lg text-sm sm:text-base md:text-lg transition-all duration-200 hover:-translate-y-0.5 text-center"
          >
            Request a Quote
          </a>
          <a
