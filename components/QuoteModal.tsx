              ...
              >
                {submitted ? (
                  ...
                  <div className="px-8 py-12 text-center">
                    ...
                    <h3 className="text-xl font-bold text-[#1e3056] mb-1">
                      Request sent!
                    </h3>
                    ...
                    <div className="px-7 pt-6 pb-5">
                      <div className="flex items-center justify-between mb-5">
                        <div className="flex items-center gap-2">
                          <span
                            className={`w-6 h-6 rounded-full text-xs font-bold flex items-center justify-center transition-colors duration-200 ${step === 1 ? "bg-orange-500 text-white" : "bg-green-500 text-white"}`}
                          >
                            {step > 1 ? "✓" : "1"}
                          </span>
                          <div className="w-8 h-px bg-gray-200" />
                          <span
                            className={`w-6 h-6 rounded-full text-xs font-bold flex items-center justify-center transition-colors duration-200 ${step === 2 ? "bg-orange-500 text-white" : "bg-gray-200 text-gray-400"}`}
                          >
                            2
                          </span>
                        </div>
                      ...
                      <h2 className="text-xl font-bold text-[#1e3056]">
                        Get a Quote
                      </h2>
                    </div>
                        ...
                        >
                          ...
                          <div>
                            ...
                            {form.customColors && (
                              <p className="text-xs text-gray-400 mt-1.5">
                                Describe your colors in the message below
                              </p>
                            )}
                          </div>
                          ...
                          <div className="flex items-center gap-6">
                            <label className="flex items-center gap-2 cursor-pointer select-none">
                              <input
                                type="checkbox"
                                checked={form.playerNames}
                                onChange={(e) =>
                                  setForm((f) => ({
                                    ...f,
                                    playerNames: e.target.checked,
                                  }))
                                }
                            ...
                            <label className="flex items-center gap-2 cursor-pointer select-none">
                              <input
                                type="checkbox"
                                checked={form.playerNumbers}
                                onChange={(e) =>
                                  setForm((f) => ({
                                    ...f,
                                    playerNumbers: e.target.checked,
                                  }))
                                }
                                className="w-4 h-4 rounded border-gray-300 accent-orange-500 cursor-pointer"
                              />
                          ...
                          <div>
                            ...
                            {imagePreview ? (
                              <div className="relative inline-block">
                                ...
                                <p className="text-xs text-gray-400 mt-1.5 truncate max-w-[180px]">
                                  {imageFile?.name}
                                </p>
                              </div>
                            ) : (
                              ...
                              >
                                <svg
                                  className="w-6 h-6 text-gray-300 group-hover:text-orange-500 transition-colors"
                                  fill="none"
                                  stroke="currentColor"
                                  viewBox="0 0 24 24"
                                >
