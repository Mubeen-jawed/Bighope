...
const partners = [
  ...
  },
  {
    ...
    cta: { label: "Call US Shop", href: "tel:+17473547351" },
  },
  {
    name: "Australia",
    flagCode: "au",
    tileColor: "border-gray-300",
    role: "Australian Partner Support",
    address: "Australia",
    phone: null,
    email: "info@bighopesports.com",
    hours: "Mon – Fri: 9:00 AM – 5:00 PM AEST",
    focus: [
      "Australia & Oceania orders",
      "Club & school partnerships",
      "Local currency support",
      "Regional logistics coordination",
    ],
    cta: { label: "Email AU Team", href: "mailto:info@bighopesports.com" },
  },
  {
    name: "Spain",
    flagCode: "es",
    ...
    focus: [
      "Spain & Southern Europe orders",
      "European club support",
